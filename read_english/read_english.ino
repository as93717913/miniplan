...
char mode='M';
int steps=0;
//int now_motion[27][19];
int max_steps;
int now_motion_num=0;
...
int Servo_Prg_14 [][ALLMATRIX] PROGMEM = {
  ...
  {     0,       35,      80,      60,       0,      100,     20,      80,      40,     100,      20,      110,      55,       35,       75,      120,       90,       90,      800   },      // 雙手平舉 起身 劈腿
...
int Servo_Prg_15 [][ALLMATRIX] PROGMEM = {
  ...
  {    65,      35,      80,      60,       0,       55,      20,      70,      50,     100,     70,     110,      55,       35,       75,       50,        90,       90,      800   },      // 雙手平舉 轉臂朝下 劈腿
  {    65,      35,      80,      60,       0,       55,     100,     70,      50,      10,      70,     110,      55,       35,       75,       50,        90,       90,      900   },      // 雙手平舉 轉臂朝前 起身 劈腿
  {     0,       35,      80,      60,       0,       15,      20,      70,      50,     100,     105,     110,      55,       35,       75,      120,       90,       90,      700   },      // 雙手平舉 轉臂平舉 起身 劈腿 腳掌朝下
  {    65,      25,      80,      60,      80,     100,     20,      80,      40,     100,      20,       30,       55,       35,       85,       50,        90,       90,      800 },      // 雙手平舉 合腿起立
  {    65,      35,      80,      60,      80,     100,     95,      80,      40,      25,       20,       30,       55,       35,       75,       50,        90,       90,      500   }       // 立正
};
/*---------------------------------------------------------------------------*/

int     Servo_Prg_16_Step=       28;
int     Servo_Prg_16  [][ALLMATRIX]      PROGMEM         =       {
//              {0,       01,      02,      03,      04,      05,       06,     07,      08,      09,      10,       11,     12,      13,      14,     15,      g12,      g14,     delay 
                ...
                {65,      35,      80,      60,      80,      100,     95,      80,      40,      25,      20,      30,      55,      35,      75,      50,      90,      90,      580},   // 10 
  }; 

  /**-------------------------------------------------------------------*/
  int     Servo_Prg_17_Step=       28;
int     Servo_Prg_17  [][ALLMATRIX]      PROGMEM         =       {
//              {0,       01,      02,      03,      04,      05,       06,     07,      08,      09,      10,       11,     12,      13,      14,     15,      g12,      g14,     delay 
                {65,      35,      80,      60,      80,      100,     95,      80,      40,      25,      20,      30,      55,      35,      75,      50,      90,      90,      100},   // 1 
                ...
                {65,      35,      80,      60,      80,      100,     95,      80,      40,      25,      20,      30,      55,      35,      75,      50,      90,      90,      340},   // 10 
  }; 
/*============================================================================*/
int     Servo_Prg_18_Step=       6;
int     Servo_Prg_18 [][ALLMATRIX]    PROGMEM         =       {
                {54,     44,     80,     68,     80,     100,    95,     80,     40,     25,     20,     30,     60,     35,     78,     48,     90,     90,     30},  //
                {57,     53,     51,     47,     78,     109,    95,     80,     40,     25,     29,     33,     54,     35,     73,     48,     90,     90,     60},  //
                {65,     33,     80,     56,     80,     115,    95,     80,     40,     25,     50,     30,     48,     35,     67,     50,     90,     90,     60},  //
                {69,     33,     80,     56,     81,     100,    95,     81,     41,     25,     20,     31,     48,     35,     67,     63,     90,     90,     30},  //
                {69,     39,     80,     62,     78,     91,     95,     81,     41,     25,     11,     34,     69,     64,     58,     60,     90,     90,     60},  //
                {65,     44,     80,     68,     80,     71,     95,     80,     40,     25,     6,      30,     60,     35,     78,     50,     90,     90,     60},  //
        };
/**-----------------------------------------------------------------*/
...
/*============================================================================*/
void next_frame(int iMatrix[][19],  int steps)
{
  int INT_TEMP_A, INT_TEMP_B, INT_TEMP_C;

 
    // InterTotalTime 此步驟總時間
    int InterTotalTime = iMatrix [ steps ] [ ALLMATRIX - 1 ] + (int8_t)EEPROM.read(ALLMATRIX - 1);
    ...
    for ( int InterStepLoop = 0; InterStepLoop < InterDelayCounter; InterStepLoop++)
    {
      ...
      for (int ServoIndex = 0; ServoIndex < ALLSERVOS; ServoIndex++)  // 馬達主迴圈
      {
        ...
        INT_TEMP_B = iMatrix[steps][ServoIndex] + (int8_t)EEPROM.read(ServoIndex);    // 馬達目標位置
    ...
    for ( int Index = 0; Index < ALLMATRIX; Index++)
    {
      Running_Servo_POS[Index] = iMatrix[steps][Index] + (int8_t)EEPROM.read(Index);
    }
        ...
        case 'M':
          ...
          while(!Serial.available()){}
              switch(Serial.read())
              {
                    ...
                    case 'B':  // 動作 1
                     steps=0;
                     max_steps=Servo_Prg_1_Step;
                     now_motion_num=1;
                      break;
                    case 'C':  // 動作 2
                     steps=0;
                     max_steps=Servo_Prg_2_Step;
                     now_motion_num=2;
                      break;
                    case 'D':  // 動作 3
                     steps=0;
                     max_steps=Servo_Prg_3_Step;
                     now_motion_num=3;
                      break;
                    case 'E':  // 動作 4
                     steps=0;
                     max_steps=Servo_Prg_4_Step;
                     now_motion_num=4;
                      break;
                    case 'F':  // 動作 5
                    steps=0;
                     max_steps=Servo_Prg_5_Step;
                    now_motion_num=5;
                      break;
                    case 'G':  // 動作 6
                     steps=0;
                     max_steps=Servo_Prg_6_Step;
                     now_motion_num=6;
                       break;
                        case 'H':  // 動作 6
                     steps=0;
                     max_steps=Servo_Prg_10_Step;
                     now_motion_num=10;
                       break;
                        case 'I':  // 動作 6
                     steps=0;
                     max_steps=Servo_Prg_11_Step;
                     now_motion_num=11;
                       break;
                        case 'J':  // 動作 6
                     steps=0;
                     max_steps=Servo_Prg_12_Step;
                     now_motion_num=12;
                       break;
                        case 'K':  // 動作 6
                     steps=0;
                     max_steps=Servo_Prg_13_Step;
                     now_motion_num=13;
                       break;
                        case 'L':  // 動作 6
                     steps=0;
                     max_steps=Servo_Prg_14_Step;
                     now_motion_num=14;
                       break;
                        case 'M':  //仰起
                     steps=0;
                     max_steps=Servo_Prg_15_Step;
                     now_motion_num=15;
                       break;
                        case 'N':  //趴起
                     steps=0;
                     max_steps=Servo_Prg_16_Step;
                     now_motion_num=16;
                       break;
                        case 'O':  // 動作 6
                     steps=0;
                     max_steps=Servo_Prg_17_Step;
                     now_motion_num=17;
                       break;
                      case 'P':  //快走
                     steps=0;
                     max_steps=Servo_Prg_18_Step;
                     now_motion_num=18;
                       break;
 ...
 if(mode=='M')
  {
    if(now_motion_num!=0)
    {
      ...
      switch(now_motion_num)
       {
         case 1:
          next_frame(Servo_Prg_1,steps);
          break;
         case 2:
         next_frame(Servo_Prg_2,steps);
          break;
         case 3:
         next_frame(Servo_Prg_3,steps);
          break;
         case 4:
         next_frame(Servo_Prg_4,steps);
          break;
         case 5:
         next_frame(Servo_Prg_5,steps);
          break;
         case 6:
         next_frame(Servo_Prg_6,steps);
          break;
           case 10:
         next_frame(Servo_Prg_10,steps);
          break;
           case 11:
         next_frame(Servo_Prg_11,steps);
          break;
           case 12:
         next_frame(Servo_Prg_12,steps);
          break;
           case 13:
         next_frame(Servo_Prg_13,steps);
          break;
          case 14:
         next_frame(Servo_Prg_14,steps);
          break;
          case 15:
         next_frame(Servo_Prg_15,steps);
          break;
          case 16:
         next_frame(Servo_Prg_16,steps);
          break;
          case 17:
         next_frame(Servo_Prg_17,steps);
          break;
          case 18:
         next_frame(Servo_Prg_18,steps);
          break;
       }
       steps++;
      }
